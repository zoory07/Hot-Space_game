...
public class Level_01_Decierto_Animacion {
    ...
    public Level_01_Decierto_Animacion(long intervaloAnimacion) {
   ...
   private void cargarImagenes() {
     imagenes = new BufferedImage[1]; // imagenes desde 00 hasta 13, necesitas un arreglo de tamaño 14
     for (int i = 0; i <= 1; i++) {
        try {
            if (i < 10) {
            ...
            String ruta = "/resources/animaciones/survival/Part2Decierto_" + numeroImagen + ".png";
