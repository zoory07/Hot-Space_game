...
public class Zanahoria extends Entity {

    private BufferedImage sprite;
    private boolean activo;

    public Zanahoria(BufferedImage sprite, int ancho, int alto) {
    ...
    public void inicializarHitbox() {
        int hbW = (int)(width  * 0.7);
        int hbH = (int)(height * 0.7);
